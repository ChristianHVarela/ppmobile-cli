...
export default function HorasMaquina(){
    ...
    const [parte2, setParte2] = useState('^FS^FO50,340^FD694.341.160-82^FS^FO50,380^FDR. Severino Jucatigre, 254^FS^FO50,420^FDBairro Jorge Bico, Rolandia PR^FS^FO50,500^GB700,3,3^FS^FX Quadrado Grande^FO50,550^GB700,750,3^FS^FX quadrado data^FO70,580^GB300,80,3^FS^FX quadrado valor^FO430,580^GB300,80,3^FS^CFA,20^FO90,590^FDData de vencimento^FS^FO450,590^FDValor^FS^CFA,30^FO100,620^FD')
    const [parte3, setParte3] = useState('^FS^FO460,620^FDR$ ')
    const [parte4, setParte4] = useState('^FS^FX Quadrado dos servicos^FO70,680^GB660,600,3^FS^CFA,20^FO90,700^FDServico^FS^FO470,700^FDQuantidade^FS^FO610,700^FDValor^FS^FX CODIGO DE BARRAS^FX nao sei como limitar o tamanho do codigo de barras^BY5,2,200^FO60,1340^BCn,150^FD123456789^FS^CFA,20^FO90,1550^FDTalvez outros dados do savado^FS^FO90,1570^FDNao sei quais dados sao obrigatorios nesse tipo deguia^FS^FO470,1610^FDAutenticacao mecanica^FS^XZ')
